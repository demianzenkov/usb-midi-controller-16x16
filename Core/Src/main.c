...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : D2_RS_Pin D14_CS_Pin D41_CS_Pin D31_CS_Pin
                           D13_CS_Pin */
  ...
  /*Configure GPIO pins : D23_CS_Pin D3_RS_Pin D34_CS_Pin */
  ...
  /*Configure GPIO pins : D2_RESET_Pin D3_RESET_Pin */
  ...
  /*Configure GPIO pins : D33_CS_Pin D32_CS_Pin D24_CS_Pin D44_CS_Pin
                           D1_RS_Pin */
  ...
  /*Configure GPIO pins : ENC34_B_Pin ENC44_A_Pin ENC21_B_Pin */
  GPIO_InitStruct.Pin = ENC34_B_Pin|ENC44_A_Pin|ENC21_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : ENC34_A_Pin ENC44_B_Pin ENC21_A_Pin ENC12_A_Pin */
  GPIO_InitStruct.Pin = ENC34_A_Pin|ENC44_B_Pin|ENC21_A_Pin|ENC12_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : D43_CS_Pin D11_CS_Pin D22_CS_Pin D12_CS_Pin */
  ...
  /*Configure GPIO pin : D4_RESET_Pin */
  ...
  /*Configure GPIO pins : D42_CS_Pin D3_EN_Pin D1_EN_Pin */
  ...
  /*Configure GPIO pins : ENC43_A_Pin ENC33_B_Pin ENC42_B_Pin */
  GPIO_InitStruct.Pin = ENC43_A_Pin|ENC33_B_Pin|ENC42_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : ENC43_B_Pin ENC33_A_Pin ENC42_A_Pin */
  GPIO_InitStruct.Pin = ENC43_B_Pin|ENC33_A_Pin|ENC42_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : ENC41_A_Pin ENC41_B_Pin ENC12_B_Pin */
  GPIO_InitStruct.Pin = ENC41_A_Pin|ENC41_B_Pin|ENC12_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : D4_RS_Pin D21_CS_Pin */
  ...
  /*Configure GPIO pins : ENC32_A_Pin ENC31_A_Pin ENC11_A_Pin ENC13_A_Pin
                           ENC14_A_Pin */
  ...
  /*Configure GPIO pins : ENC32_B_Pin ENC31_B_Pin ENC24_B_Pin ENC24_A_Pin
  ...
  /*Configure GPIO pins : ENC22_A_Pin ENC23_A_Pin */
  GPIO_InitStruct.Pin = ENC22_A_Pin|ENC23_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : ENC22_B_Pin ENC23_B_Pin */
  GPIO_InitStruct.Pin = ENC22_B_Pin|ENC23_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : D1_RESET_Pin */
